...
#if UNITY_2018_3_OR_NEWER
      if (pi.prefabType == PrefabTypes.NestedPrefab || pi.prefabType == PrefabTypes.NestedPrefabInstance)
      {
        pi.nestedParentGameObjectID = PrefabUtility.GetOutermostPrefabInstanceRoot(go).GetInstanceID();
      }
#endif
